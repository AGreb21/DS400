...
1.  Prior: π∼Beta(20,3), data: Y=0 successes in n=1 trial
...
1.  Prior: π∼Beta(4,2), data: Y=1 success in n=3 trials

```{r}
plot_beta_binomial(alpha = 4, beta = 2, y = 1, n = 3)
```

the posterior is an equal compromise between the data and the prior or the prior has more influence on the posterior, close to call

1.  Prior: π∼Beta(3,10), data: Y=10 successes in n=13 trials
...
1.  Prior: π∼Beta(20,2), data: Y=10 successes in n=200 trials
